...
let setLightColorHsv = new Skill({
    identifier: "setLightColorHsv",
    title: "Color - HSV",
    description: "Set the color of the light using hsv values. Value range is: Hue: 0-360, Saturation: 0 - 100, Brightness: 0-100",
    variables: {
...
let setLightColorRgb = new Skill({
    identifier: "setLightColorRgb",
    title: "Color - RGB",
    description: "Set the color of the light using rgb values. Value range is 0-255",
    variables: {
        lightId: Skill.variableTypes.light,
